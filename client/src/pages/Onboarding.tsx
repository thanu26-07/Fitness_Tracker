            ...
            {/* Header */}
                <div className="p-6 pt-12 onboarding-wrapper">
                    <div className="flex items-center gap-3 mb-2">
                        <div className="w-10 h-10 rounded-xl bg-emarald-500 flex items-center justify-center">
                ...
                <div className="flex-1 px-6 onboarding-wrapper">
                        ...
                        <div className="space-y-6 onboarding-wrapper">
                            ...
                            <div className="space-y-8  max -w-lg">
                                ...
                                <div className="space-y-6">
                                    ...
                                    <Slider label="Daily Calorie Burn"  min={100} max={2000} step={50} value={formData.dailyCalorieBurn} onChange={(v)=>updateField('dailyCalorieBurn', v)} unit= "kcal" infoText="The total calories you  aim to burn through activities and exercise each day."/>
                  ...
                  <div className="p-6 pb-10 onboarding-wrapper">
                    <div className="flex gpa-3 lg:justify-end">
                        {step>1 && (
