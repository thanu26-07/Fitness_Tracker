...
const Dashboard = () => {
  ...
  const totalCalories: number =
    todayFood.reduce((sum, item) => sum + item.calories, 0)

  const remainingCalories: number =
    DAILY_CALORIE_LIMIT - totalCalories

  const totalActiveMinutes: number =
    todayActivities.reduce((sum, item) => sum + item.duration, 0)
      ...
      <div className="dashboard-grid">
        ...
        {user && (
          ...
          <Card className="bg-linear-to-r from-slate-800 to-slate-700">
            ...
            <div className="w-12 h-12 rounded-x1 bg-white/10 flex items-center justify-center">
